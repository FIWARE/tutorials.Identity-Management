...
This tutorial is an introduction to [Keycloak](https://www.keycloak.org/) — an open-source Identity and Access
...
-   [Start Up](#start-up)
    -   [Reading the Keycloak Admin API](#reading-the-keycloak-admin-api)
    -   [UUIDs within Keycloak](#uuids-within-keycloak)
    -   [Logging In](#logging-in)
        -   [Obtain an Admin Token](#obtain-an-admin-token)
        -   [Retrieve User Details from a Token](#retrieve-user-details-from-a-token)
...
-   [Grouping User Accounts under Groups](#grouping-user-accounts-under-groups)
    -   [Group CRUD Actions](#group-crud-actions)
        -   [Create a Group](#create-a-group)
        -   [Read Group Details](#read-group-details)
        -   [List all Groups](#list-all-groups)
        -   [Update a Group](#update-a-group)
        -   [Delete a Group](#delete-a-group)
    -   [Users within a Group](#users-within-a-group)
        -   [Add a User as a Member of a Group](#add-a-user-as-a-member-of-a-group)
        -   [List Users within a Group](#list-users-within-a-group)
...
## Reading the Keycloak Admin API
